...
====================
Assemblage complet du pipeline Sparse VAE.
DINOv2 (frozen) + ProjectionHead + SparseLatentLayer + MultiScaleDecoder.
"""
...
class SparseVAE(nn.Module):
    ...
    DINOv2 est frozen — non inclus dans state_dict de ce module.
    Charger DINOv2 séparément avec load_dinov2() et le passer à forward().
    """

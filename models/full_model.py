...
class SparseVAE(nn.Module):
    ...
    def forward(self, image: torch.Tensor) -> dict:
        ...
        Returns dict with keys:
            mu, logvar, z_sparse, mask, kl, kl_per_dim
        ...
        # ③ Sparse Latent → z_sparse, kl, kl_per_dim, mask
        z_sparse, kl, kl_per_dim, mask = self.sparse_latent(mu, logvar)
        ...
        return {
            ...
            "mask":        mask,
            "kl":          kl,
            "kl_per_dim":  kl_per_dim,   # (latent_dim,) — pour KController
            # Reconstructions
    ...
    def encode(self, image: torch.Tensor):
        ...
        mu, logvar      = self.projection_head(patch_tokens)
        # kl et kl_per_dim ignorés à l'inférence
        z_sparse, kl, kl_per_dim, mask = self.sparse_latent(mu, logvar)
